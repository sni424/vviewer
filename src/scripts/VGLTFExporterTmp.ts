...
declare module 'three-stdlib' {
    interface GLTFWriter {
        ...
        buildMetalRoughTexture(metalnessMap: THREE.Texture, roughnessMap: THREE.Texture): THREE.Texture;
        ...
        serializeUserData(material: THREE.Material, materialDef: PartialMaterialDef): void;
...
function equalArray(array1: any[], array2: any[]) {
    return (array1.length === array2.length) && array1.every(function(element: any, index: number) {
