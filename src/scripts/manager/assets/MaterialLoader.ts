...
export default async function (file: VFile | VRemoteFile) {
  return _Asset
    .vfile<VFile<VMaterial>>(file)
    .then(async (vfile: VFile<VMaterial>) => {
      if (!isVFile(vfile)) {
      ...
      return awaitAll(awaitData).then(data => {
        ...
        if (data.stencilZFail !== undefined)
          mat.stencilZFail = data.stencilZFail;
        if (data.stencilZPass !== undefined)
          mat.stencilZPass = data.stencilZPass;
        if (data.stencilWrite !== undefined)
          mat.stencilWrite = data.stencilWrite;
        ...
        if (data.roughnessMap !== undefined)
          mat.roughnessMap = data.roughnessMap;
        if (data.metalnessMap !== undefined)
          mat.metalnessMap = data.metalnessMap;
        ...
        if (data.reflectivity !== undefined)
        ...
        if (data.clearcoatMap !== undefined)
          mat.clearcoatMap = data.clearcoatMap;
        ...
        if (data.thicknessMap !== undefined)
          mat.thicknessMap = data.thicknessMap;
