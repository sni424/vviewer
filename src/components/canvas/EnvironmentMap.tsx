...
function MyEnvironment() {
    ...
    if (env.select === "preset") {
        return <Environment preset={env.preset ?? "apartment"} environmentIntensity={intensity} environmentRotation={rotation} />
    }
    ...
    if (env.select === "custom" || env.select === "url") {
        ...
        return <Environment files={env.url} environmentIntensity={intensity} environmentRotation={rotation} />
    }
}
