...
import { cached, compressObjectToFile, formatNumber, groupInfo, isProbeMesh, isTransformControlOrChild, loadLatest, loadScene, saveScene, setAsModel, toNthDigit } from '../scripts/utils';
...
const GeneralButtons = () => {
    ...
    return <section style={{ width: "100%", display: "grid", gap: 8, gridTemplateColumns: "1fr 1fr 1fr" }}>
        <button onClick={() => {
            navigate("/mobile");
        }}>모바일</button>
...
const GeneralPostProcessingControl = () => {
    ...
    return <section style={{ marginTop: 16, fontSize: 13, display: "flex", flexDirection: "column", gap: 6 }}>
        <div>
            <strong>밝기/대비</strong>
