...
const XYZGizmo = () => {
    ...
    const gizmoCameraRef = React.useRef<THREE.PerspectiveCamera | null>(new THREE.PerspectiveCamera(0, 1, 0, 0));
    ...
    return <Canvas className='w-full h-full'
        scene={three.scene} camera={gizmoCameraRef.current!}>
        <GizmoHelper
        ...
        >
            <GizmoViewport layers={Layer.GizmoHelper} name='GizmoHelper' axisColors={['red', 'green', 'blue']} labelColor="black" />
        </GizmoHelper>
    </Canvas>
}
